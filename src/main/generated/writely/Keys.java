...
public class Keys {
    ...
    public static final UniqueKey<TermsAgreeRecord> TERMS_AGREE_PK = Internal.createUniqueKey(TermsAgree.TERMS_AGREE, DSL.name("terms_agree_pk"), new TableField[] { TermsAgree.TERMS_AGREE.TERMS_ID, TermsAgree.TERMS_AGREE.MEMBER_ID }, true);
}
