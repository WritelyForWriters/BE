...
public class TermsAgree extends TableImpl<TermsAgreeRecord> {
    ...
    /**
     * The column <code>public.terms_agree.terms_cd</code>. 약관 코드
     */
    public final TableField<TermsAgreeRecord, String> TERMS_CD = createField(DSL.name("terms_cd"), SQLDataType.VARCHAR(10).nullable(false), this, "약관 코드");
