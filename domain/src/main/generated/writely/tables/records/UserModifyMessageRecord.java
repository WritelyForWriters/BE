...
public class UserModifyMessageRecord extends UpdatableRecordImpl<UserModifyMessageRecord> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>public.user_modify_message.id</code>.
     */
    public UserModifyMessageRecord setId(UUID value) {
        set(0, value);
        return this;
    }
    ...
    /**
     * Create a detached UserModifyMessageRecord
     */
    public UserModifyMessageRecord() {
     ...
     * Create a detached, initialised UserModifyMessageRecord
     */
    public UserModifyMessageRecord(writely.tables.pojos.UserModifyMessage value) {
        super(UserModifyMessage.USER_MODIFY_MESSAGE);
