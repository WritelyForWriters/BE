...
public class Keys {
    ...
    public static final UniqueKey<ChatMessageRecord> CHAT_MESSAGE_PK = Internal.createUniqueKey(ChatMessage.CHAT_MESSAGE, DSL.name("chat_message_pk"), new TableField[] { ChatMessage.CHAT_MESSAGE.ID }, true);
