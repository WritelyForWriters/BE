...
public class Terms extends TableImpl<TermsRecord> {
    ...
    /**
     * The column <code>public.terms.is_required</code>. 동의 필수 여부
     */
    public final TableField<TermsRecord, Boolean> IS_REQUIRED = createField(DSL.name("is_required"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "동의 필수 여부");
