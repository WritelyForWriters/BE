...
public class Assistant extends TableImpl<AssistantRecord> {
    ...
    /**
     * The column <code>public.assistant.is_applied</code>. 진행 상태
     */
    public final TableField<AssistantRecord, Boolean> IS_APPLIED = createField(DSL.name("is_applied"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "진행 상태");
