...
public class Assistant extends TableImpl<AssistantRecord> {
     ...
     */
    public final TableField<AssistantRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.assistant.product_id</code>.
     */
    public final TableField<AssistantRecord, UUID> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.assistant.type</code>.
     */
    public final TableField<AssistantRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>public.assistant.status</code>.
     */
    public final TableField<AssistantRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>public.assistant.is_applied</code>.
     */
    public final TableField<AssistantRecord, Boolean> IS_APPLIED = createField(DSL.name("is_applied"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>public.assistant.created_at</code>.
     */
    public final TableField<AssistantRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>public.assistant.created_by</code>.
     */
    public final TableField<AssistantRecord, UUID> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.assistant.updated_at</code>.
     */
    public final TableField<AssistantRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6), this, "");
