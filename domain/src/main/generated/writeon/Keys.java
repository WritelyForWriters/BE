...
public class Keys {
    ...
    public static final UniqueKey<AssistantPlannerMessageRecord> ASSISTANT_PLANNER_MESSAGE_PK = Internal.createUniqueKey(AssistantPlannerMessage.ASSISTANT_PLANNER_MESSAGE, DSL.name("assistant_planner_message_pk"), new TableField[] { AssistantPlannerMessage.ASSISTANT_PLANNER_MESSAGE.ASSISTANT_ID }, true);
    ...
    public static final UniqueKey<ProductHistoryRecord> PRODUCT_HISTORY_PKEY = Internal.createUniqueKey(ProductHistory.PRODUCT_HISTORY, DSL.name("product_history_pkey"), new TableField[] { ProductHistory.PRODUCT_HISTORY.ID }, true);
